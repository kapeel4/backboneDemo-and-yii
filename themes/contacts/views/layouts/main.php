...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/alertify.bootstrap.css"/>
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/alertify.core.css"/>
...
<script type="text/template" id="imageupload">
 ...
 <input id="photo" type="file"  class = "inputfile col-sm-2 control-label" /><br/>
</script>
</head>
